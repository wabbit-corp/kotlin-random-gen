...
// managed-integrity-v1: 4JfYRjzfkg4
//
...
mavenPublishing {
    coordinates("one.wabbit", "kotlin-random-gen", project.version.toString())
    publishToMavenCentral()
    signAllPublications()
    pom {
        name.set("kotlin-random-gen")
        description.set("Kotlin Multiplatform random data generation combinators built on kotlin-random.")
...
publishing {
    publications.withType<org.gradle.api.publish.maven.MavenPublication>().configureEach {
        val configuredArtifactId = "kotlin-random-gen"
...
kotlin {
    ...
    sourceSets {
        val commonMain by getting {
            dependencies {
                implementation("one.wabbit:kotlin-data-need:2.0.0")

                implementation("one.wabbit:kotlin-base58:2.0.0")

                implementation("one.wabbit:kotlin-random:2.0.0")
